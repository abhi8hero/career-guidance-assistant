...
// ---------------- CAREER RULES ----------------
const careerRules = [
  {name:"Software Engineer", tags:["Technology","Mathematics","Technical","Problem Solving"], phase:["After 10th","After 12th","Graduation"], roadmap:["Degree in CS","Learn Programming","Build Projects","Apply for jobs"], skills:["Programming","Problem Solving","Logical Thinking","Teamwork"]},
  {name:"UI/UX Designer", tags:["Creativity","Design","Technology"], phase:["After 10th","After 12th","Graduation"], roadmap:["Learn Design Tools","Online Courses","Create Portfolio","Apply for internships"], skills:["Creativity","Design Thinking","Wireframing","User Research"]},
  {name:"Business & Management", tags:["Business","Leadership","Communication"], phase:["After 10th","After 12th","Graduation","Career Switch"], roadmap:["Degree in Business","Learn Finance & Marketing","Internships","Networking"], skills:["Leadership","Communication","Strategy","Time Management"]},
  {name:"Healthcare Professional", tags:["Helping People","Science"], phase:["After 10th","After 12th"], roadmap:["Pursue Medical Courses","Internships","Residency/Training","Apply for roles"], skills:["Empathy","Observation","Problem Solving","Communication"]}
];
